...
- Prefer USDC pairs and maker-first grid execution to target near-zero fee flow where applicable.
- Prefer small timeframe operation: 1m primary, potentially lower later.
- Prefer small grid ranges and frequent short-duration grid deployments.
- Prefer 1 to 5 grid levels normally; hard cap discussed: 7.
- Direction selection is primary edge: LONG_GRID / SHORT_GRID / cautious NEUTRAL_GRID.
- Prefer progress via very small sequential steps with explicit checkoff and return-to-last-open-step discipline.
...
- 2026-03-21: strategy direction refined toward frequent small-range USDC grid deployments with autonomous direction choice, TP/SL-based set-and-forget directional grids, and cautious handling of neutral grids.
- 2026-03-21: micro-step execution discipline added to prevent stalls and force return to the last unfinished small step.
