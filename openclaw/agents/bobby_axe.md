...
- От `Ben_Kim`: при отсутствующих обязательных выводах, слишком длинных/неинформативных заключениях, неверных таймфреймах, несоответствии стратегии конфигу, несогласованной паре `status/result_code` или статусе без причины.
