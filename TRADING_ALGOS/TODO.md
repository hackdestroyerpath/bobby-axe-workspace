...
- какой артефакт в репозитории подтверждает завершение;
- какой пример payload/output приложен.

Закрытие задачи разрешается только при наличии всех пунктов DoD.
