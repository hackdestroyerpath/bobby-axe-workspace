...
BEN_KIM_ORCHESTRATION_EXPECTATIONS = {
    ...
    "traceability": "Every response must carry request_id/requested_at/generated_at/response_contract_version at the top level and source_contract_version/build_version/machine_id/api_key_id in traceability fields.",
